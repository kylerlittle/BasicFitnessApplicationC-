...
public:
	...
	ExercisePlan(string newName = "", int newGoalsteps = 0, string newDate = "00/00/0000");
	...
	// Description: Displays user's current number of goal steps, then prompts user 
	//				to enter a new number of goal steps. Stores into object.
	void editGoal();

private:
	int mGoalSteps;			// number of desired steps for a day
